...
// posting a new tweet
T.post('statuses/update', { status: 'hello world! fifth tweet :D' }, function(err, data, response) {
    console.log(data)
  });

// retweet the tweet with given tweet ID
T.post('statuses/retweet/:id', { id: '969924361145724929' }, function (err, data, response) {
    console.log(data.id)
  })

// get details of a tweet with it's tweet id
T.get('statuses/show/:id', { id: '969950433816047617' }, function (err, data, response) {
    ...
    console.log("the tweeted user name: ",data.user.name);
